...
/*! \brief Gets the number of registered servers from the context
 *
 * \param ctx Server context
 * \return Number of servers on in the context
 */
int chirc_ctx_numservers(chirc_ctx_t *ctx) ;

/*! \brief Gets the number of connections in the server
 *
 * Note that this function will exclude unknown connections.
 *
 * \param ctx Server context
 * \return Number of connections in server
 */
int chirc_ctx_numconnections(chirc_ctx_t *ctx);
...
/*! \brief Gets the number of channelusers in a channel
 *
 * \param channel Channel
 * \return Number of channelusers in the channel
 */
int chirc_ctx_numchannelusers(chirc_channel_t *channel);
